...
class DetailMedCetakFlyerRelationManager extends RelationManager
{
    protected static string $relationship = 'permohonanDetMedKomCetak';
    const KEGIATAN_ID = '9e9e8cf5-d669-4088-bf31-94fdce52779c';
    ...
    {
        return static::getTargetKegiatan()?->nama ?? 'Flyer';
    }
